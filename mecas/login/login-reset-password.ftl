...
<@layout.registrationLayout displayInfo=true; section>
    ...
    <#elseif section = "header">
        ${msg("emailForgotTitle")}
    <#elseif section = "form">
        <form id="sso-reset-password-form" class="form reset-password ${properties.kcFormClass!}" action="${url.loginAction}" method="post">
            ...
            <div class="${properties.kcFormGroupClass!} row">
                <div id="sso-form-options" class="${properties.kcFormOptionsClass!} col-xs-5">
                ...
                <div id="sso-form-buttons" class="${properties.kcFormButtonsClass!} col-xs-7">

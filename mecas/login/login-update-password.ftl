...
<@layout.registrationLayout displayInfo=true; section>
    ...
    <#elseif section = "header">
        ${msg("updatePasswordTitle")}
    <#elseif section = "form">
        <form id="sso-passwd-update-form" class="form update-password ${properties.kcFormClass!}" action="${url.loginAction}" method="post">
            ...
            <div class="${properties.kcFormGroupClass!} row update-password-button-container">
                <div id="sso-form-options" class="${properties.kcFormOptionsClass!} col-xs-6 col-sm-8">
                    <div class="${properties.kcFormOptionsWrapperClass!}">
                    </div>
                </div>

                <div id="sso-form-buttons" class="${properties.kcFormButtonsClass!} col-xs-6 col-sm-4">
